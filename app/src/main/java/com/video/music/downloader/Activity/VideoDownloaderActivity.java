...
//        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_view, new FragmentDownload()).commit();
        ...
        AdUtils.showNativeAd(VideoDownloaderActivity.this, Constants.adsJsonPOJO.getParameters().getNative_id().getDefaultValue().getValue(), findViewById(R.id.native_ads), false);
